...
import { Trophy, MapPin, Bus, Clock, Calendar } from 'lucide-react';
...
const mockUpcoming = [
  { id: 1, team: '1st XI', vs: 'Bedfordshire CC', date: 'Sat, 22 Jul, 13:00', venue: 'Wardown Park', type: 'Home' },
  { id: 2, team: '2nd XI', vs: 'Dunstable Town CC', date: 'Sat, 29 Jul, 13:00', venue: 'Away Grounds', type: 'Away' },
  { id: 3, team: '1st XI', vs: 'St. Albans CC', date: 'Sun, 30 Jul, 11:00', venue: 'Wardown Park', type: 'Home' },
];

const mockResults = [
  { id: 1, team: '1st XI', vs: 'Ampthill Town CC', score: 'LTICC 245/6 (50) | Ampthill 190/10 (43.2)', outcome: 'Win', margin: 'won by 55 runs' },
  { id: 2, team: 'Youth', vs: 'Flitwick CC', score: 'Flitwick 180/4 (40) | LTICC 178/9 (40)', outcome: 'Loss', margin: 'lost by 2 runs' },
];
                ...
                {mockUpcoming.map((fix) => (
                  ...
                  >
                    ...
                    <div className="flex-grow">
                      <h3 className="text-xl font-bold mb-1">vs {fix.vs}</h3>
            ...
            <div className="space-y-4">
              {mockResults.map((res) => (
                ...
                >
                  ...
                  <h3 className="text-xl font-bold mb-2">vs {res.vs}</h3>
                  <p className="text-sm font-medium mb-1 text-brand-navy/70">{res.score}</p>
                  <p className={cn(
